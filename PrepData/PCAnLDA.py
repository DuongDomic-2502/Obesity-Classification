...
# ── Elbow chart — chọn n_components tối ưu cho PCA ────────
pca_full = PCA().fit(X)
...
print(f"\nCần {n_90} components để giữ 90% variance")
print(f"Cần {n_95} components để giữ 95% variance")

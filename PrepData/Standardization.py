...
#Ordinal: MTRANS, CALC, CAEC
#Target Encoding: NObeyesdad
#Binary: FAVC, SCC, SMOKE, family_history_with_overweight, Gender

#còn lại cần chuẩn hóa: Age, Height, Weight, NCP, CH2O, FAF
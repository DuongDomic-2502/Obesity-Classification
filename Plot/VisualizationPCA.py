...
for i, (a, b) in enumerate(pairs):
    ...
    ax.set_xlabel(f'PC{a+1}', fontsize=11)
    ax.set_ylabel(f'PC{b+1}', fontsize=11)
    ax.set_title(f'PC{a+1} vs PC{b+1}', fontsize=12)
...
plt.suptitle("PCA Visualization", fontsize=16)
plt.tight_layout()

# --- Lưu ảnh ---
plt.savefig(r"D:\MachineLearning\BTL\Plot\PCA_visualization.png", dpi=300, bbox_inches='tight')
plt.show()